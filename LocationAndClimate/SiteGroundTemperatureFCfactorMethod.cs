...
{
    public class SiteGroundTemperatureFCfactorMethod
    {
        ...
        public SiteGroundTemperatureFCfactorMethod() { }
        private static List<SiteGroundTemperatureFCfactorMethod> list = new List<SiteGroundTemperatureFCfactorMethod>();

        public static void Add(SiteGroundTemperatureFCfactorMethod siteGroundTemperatureFCfactorMethod)
        {
            list.Add(siteGroundTemperatureFCfactorMethod);
        }
        private static string[] Read()
        {
            ...
            {
                print[i] = $"Site:GroundTemperature:FCfactorMethod,\n" +
        ...
        public static void Get(string idfFile)
        {
            ...
            {
                foreach (string line in SiteGroundTemperatureFCfactorMethod.Read())
                {
                    sw.WriteLine(line);
                }
            }
